<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="LoginRegisterActiveAccount.Register" %>
    ...
    <section class="container">
         <div class="image-section">
            ...
            <div class="content-container">
              ...
              <p class="section-paragraph">Register Page</p>
            </div>
          </div>
        ...
        <div class="form-wrapper">
          ...
          <div class="input-container">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Login.aspx">Already User, Login Here</asp:HyperLink>
            </div>
            </div>
            </form>
          </div>
