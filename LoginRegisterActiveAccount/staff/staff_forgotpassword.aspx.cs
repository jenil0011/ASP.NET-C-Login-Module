...
{
    public partial class staff_forgotpassword : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string selectUser = "select staff_id from [staffinfo] where email='" + email.Text.ToString() + "' and is_active=1";
            ...
            if (read.Read())
            {
                ...
                con.Open();
                string updateAcc = "update [staffinfo] set fotgot_otp='" + fotgot_otp + "' where email='" + email.Text.ToString() + "'";
                ...
                emailBody += "<h1>Hello Staff,<h1/>";
                emailBody += "Click Below Link for Reset Your Password.<br/>";
                emailBody += "<p><a href='" + "https://localhost:44360/staff/staff_resetpassword.aspx?fotgot_otp=" + fotgot_otp + "" + "&email=" + email.Text.ToString() + "'>Click here to Reset Password</a></p>";
                emailBody += "Thank you...";
