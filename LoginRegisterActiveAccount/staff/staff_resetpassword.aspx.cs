...
{
    public partial class staff_resetpassword : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string checkActivation = "select staff_id from [staffinfo] where email='" + email + "' and fotgot_otp='" + forgot_otp + "'";
        ...
        protected void resetpwdBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string updateAcc = "update [staffinfo] set fotgot_otp=0,confirm_password='" + password.Text.ToString() + "',password='" + password.Text.ToString() + "' where email='" + email + "'";
