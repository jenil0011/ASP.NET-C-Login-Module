        ...
        protected void regBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (password.Text.ToString() == confirm_password.Text.ToString())
                {
                    ...
                    DateTime date = DateTime.Parse(doj.Text);
                    

                    string insertUser = "insert into [staffinfo] (first_name,last_name,contact,address,doj,email,password,confirm_password,activation_code,is_active) values(@first_name,@last_name,@contact,@address,@doj,@email,@password,@confirm_password,@activation_code,@is_active)";
                    ...
                    insertCmd.Parameters.AddWithValue("@doj", doj.Text.ToString());
                    ...
                    mail.Subject = "Thank you Staff for registering in Online Toy Shop Managment System.";

                    string emailBody = "";

                    emailBody += "<h1>Hello Staff," + firstname.Text.ToString() + ",<h1/>";
                    emailBody += "Click Below Link for activate your Account.<br/>";
                    emailBody += "<p><a href='" + "https://localhost:44360/staff/staff_activateaccount.aspx?activation_code=" + activation_code + "" + "&email=" + email.Text.ToString() + "'>Click here to activate</a></p>";
                    emailBody += "Thank you...";
