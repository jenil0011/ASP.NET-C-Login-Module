<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staff_login.aspx.cs" Inherits="LoginRegisterActiveAccount.staff.staff_login" %>
    ...
    <section class="container">
         <div class="image-section">
            ...
            <div class="content-container">
              ...
              <p class="section-paragraph">Staff Login Page</p>
            </div>
          </div>
        ...
        <div class="form-wrapper">
          <div class="logo-container">
            <a href="#" class="logo-container">
              <asp:Image ID="Image2" runat="server" src="./staff.png"/>
            </a>
          </div>
          ...
          <div class="input-container">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/staff/staff_forgotPassword.aspx">Forgot Password, Click Here</asp:HyperLink>
            </div>
            <div class="form-group">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/staff/staff_register.aspx" BorderColor="Magenta">New User, Click Here</asp:HyperLink>
            </div>
            </div>
            </form>
          </div>
