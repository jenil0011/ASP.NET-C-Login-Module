...
namespace LoginRegisterActiveAccount.admin
{
    public partial class admin_resetpassword : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            string checkActivation = "select admin_id from [admininfo] where email='" + email + "' and fotgot_otp='" + forgot_otp + "'";
        ...
        protected void resetpwdBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string updateAcc = "update [admininfo] set fotgot_otp=0,confirm_password='" + password.Text.ToString() + "',password='" + password.Text.ToString() + "' where email='" + email + "'";
