<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_login.aspx.cs" Inherits="LoginRegisterActiveAccount.admin.admin_login" %>
    ...
    <section class="container">
         <div class="image-section">
            <div class="image-wrapper">
                <asp:Image ID="Image1" runat="server" src="./mesh-gradient.jpg"/>
            </div>

            <div class="content-container">
              <h1 class="section-heading">Online Toy Shop Managment <span>System.</span></h1>
              <p class="section-paragraph">Admin Login Page</p>
            </div>
          </div>
        ...
        <div class="form-wrapper">
          <div class="logo-container">
            <a href="#" class="logo-container">
              <asp:Image ID="Image2" runat="server" src="se.png"/>
            </a>
          </div>
          ...
          <div class="input-container">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/admin/admin_forgotpassword.aspx">Forgot Password, Click Here</asp:HyperLink>
            </div>
            <div class="form-group">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/admin/admin_register.aspx" BorderColor="Magenta">New User, Click Here</asp:HyperLink>
            </div>
            </div>
            </form>
          </div>
