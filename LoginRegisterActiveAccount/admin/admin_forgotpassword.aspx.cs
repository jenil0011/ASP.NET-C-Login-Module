...
namespace LoginRegisterActiveAccount.admin
{
    public partial class admin_forgotpassword : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string selectUser = "select admin_id from [admininfo] where email='" + email.Text.ToString() + "' and is_active=1";
            ...
            if (read.Read())
            {
                ...
                con.Open();
                string updateAcc = "update [admininfo] set fotgot_otp='" + fotgot_otp + "' where email='" + email.Text.ToString() + "'";
                ...
                emailBody += "<h1>Hello Admin,<h1/>";
                emailBody += "Click Below Link for Reset Your Password.<br/>";
                emailBody += "<p><a href='" + "https://localhost:44360/admin/admin_resetpassword.aspx?fotgot_otp=" + fotgot_otp + "" + "&email=" + email.Text.ToString() + "'>Click here to Reset Password</a></p>";
                emailBody += "Thank you...";
