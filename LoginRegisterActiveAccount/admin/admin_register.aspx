<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_register.aspx.cs" Inherits="LoginRegisterActiveAccount.admin.admin_register" %>
    ...
    <section class="container">
         <div class="image-section">
            ...
            <div class="content-container">
              ...
              <p class="section-paragraph">Admin Register Page</p>
            </div>
          </div>
        ...
        <div class="form-wrapper">
          ...
          <div class="input-container">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/admin/admin_login.aspx">Already Admin User, Login Here</asp:HyperLink>
            </div>
            </div>
            </form>
          </div>
