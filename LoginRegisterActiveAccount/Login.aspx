<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LoginRegisterActiveAccount.Login" %>
    ...
    <section class="container">
         <div class="image-section">
            ...
            <div class="content-container">
              ...
              <p class="section-paragraph">Login Page</p>
            </div>
          </div>
        ...
        <div class="form-wrapper">
          <div class="logo-container">
            <a href="#" class="logo-container">
              <asp:Image ID="Image2" runat="server" src="./logo.png"/>
            </a>
          </div>
          ...
          <div class="input-container">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/ForgotPassword.aspx">Forgot Password, Click Here</asp:HyperLink>
            </div>
            <div class="form-group">
            ...
            <div class="form-group-text">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Register.aspx" BorderColor="Magenta">New User, Click Here</asp:HyperLink>
            </div>
            </div>
            </form>
          </div>
